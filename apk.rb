...
class Msf::Payload::Apk
  ...
  def backdoor_apk(apkfile, raw_payload)
   ...
   # apk_v = Gem::Version.new(apktool)
    ...
    print_status "Rebuilding #{apkfile} with meterpreter injection as #{injected_apk} and yes it's me guys...your friend Lokesh (NabinSharmaitgithub) thanx for using my tool TMUX-BUNCH \n"
