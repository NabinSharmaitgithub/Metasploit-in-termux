...
curl -LO https://raw.githubusercontent.com/NabinSharmaitgithub/Metasploit-in-termux/main/database.yml
...
cd ${PREFIX}/bin && curl -LO https://raw.githubusercontent.com/NabinSharmaitgithub/Metasploit-in-termux/main/msfconsole && chmod +x msfconsole
